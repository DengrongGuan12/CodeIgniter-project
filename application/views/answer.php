...
<section class="content">
    <section class="widget" style="height: 1100px; min-height:300px">
        ...
        <div class="content">
            <form onsubmit="return checkInputs();" action="http://127.0.0.1/CodeIgniter-project/index.php/answer_question/getData/" method="post" name="form1">
                <div class="green">
            ...
            <script type="text/javascript">
                function checkInputs(){
                    ...
                    if(content.value.length==0||content.value=="<p>Initial content</p>"||content.value=="<p><br></p>"){
                        ...
                        var url="http://127.0.0.1/CodeIgniter-project/index.php/answer_question/getData";
